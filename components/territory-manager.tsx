...
export function TerritoryManager({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-2xl bg-white/95 backdrop-blur-sm border-purple-200 shadow-xl max-h-[90vh] overflow-y-auto">
        <CardHeader>
          ...
          {territories.length === 0 ? (
            ...
            <div className="space-y-3">
              {territories.map((territory) => (
                <Card key={territory.id} className="border border-gray-200">
