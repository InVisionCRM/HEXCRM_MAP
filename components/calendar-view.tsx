  ...
  if (selectedDate) {
    ...
    return (
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <Card className="w-full max-w-md bg-white/95 backdrop-blur-sm border-purple-200 shadow-xl max-h-[80vh] overflow-y-auto">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            {selectedDateFollowUps.length === 0 ? (
              ...
              selectedDateFollowUps.map((followUp) => (
                <Card key={followUp.id} className="border border-blue-200 bg-blue-50/50">
